...
@register_model
def sparse_deit_tiny_patch16_224(pretrained=False, N=2, M=4, search=False, **kwargs):
    model =SparseVisionTransformer(
        patch_size=16, embed_dim=192, depth=12, num_heads=3, mlp_ratio=4, qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), N=N, M=M,search=search, **kwargs)
...
@register_model
def sparse_deit_small_patch16_224(pretrained=False,  N=2, M=4, search=False, **kwargs):
    model =SparseVisionTransformer(
...
@register_model
def sparse_deit_base_patch16_224(pretrained=False, N=2, M=4, search=False, **kwargs):
    model =SparseVisionTransformer(
